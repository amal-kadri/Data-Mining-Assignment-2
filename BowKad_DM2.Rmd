...
coef_vector
# coef_vector = replace(coef_vector,1, "price")
coef_vector
# coef_fields = coefData[2:nrow(coefData),1]
f <- as.formula(
  paste("price", 
        paste(coef_fields, collapse = " + "), 
        sep = " ~ "))
# 
...
# length(kredit_test$Default)
# length(kredit_test$yhat_t)
# confusionMatrix(data = kredit_test$Default, reference = kredit_test$yhat_t)
